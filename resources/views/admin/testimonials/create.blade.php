                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="client_position" id="client_position" class="form-control" value="{{ old('client_position') }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="client_company" id="client_company" class="form-control" value="{{ old('client_company') }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="client_avatar">Avatar URL</label>
                            <input type="url" name="client_avatar" id="client_avatar" class="form-control" value="{{ old('client_avatar') }}">
                        </div>
                    </div>
                </div>
