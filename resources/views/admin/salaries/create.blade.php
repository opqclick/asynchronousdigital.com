    ...
    <div class="card">
        ...
        <form action="{{ route('admin.salaries.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="project_id">Project <small class="text-muted">(optional - leave empty for general salary)</small></label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control @error('bonus_amount') is-invalid @enderror" 
                                   id="bonus_amount" name="bonus_amount" value="{{ old('bonus_amount', 0) }}">
                            @error('bonus_amount')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control @error('deduction_amount') is-invalid @enderror" 
                                   id="deduction_amount" name="deduction_amount" value="{{ old('deduction_amount', 0) }}">
