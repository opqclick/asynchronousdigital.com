...
<body class="bg-slate-900 text-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    class="nav-link text-purple-400 px-3 py-2">Dashboard</a>@endauth
                </div>
                <button id="mobile-menu-button" class="md:hidden text-slate-300"><i
            ...
            <div id="mobile-menu" class="mobile-menu md:hidden">
                <div class="px-2 pt-2 pb-3 space-y-1">
                    ...
                    @auth<a href="{{ route('dashboard') }}"
                    class="block text-purple-400 hover:bg-slate-800 px-3 py-2 rounded">Dashboard</a>@endauth
                </div>
            </div>
        </div>
    </nav>
    ...
    <section id="home" class="relative pt-24 pb-20 px-4 min-h-screen flex items-center overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto text-center relative z-10 w-full">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                <a href="#contact"
                    class="px-8 py-4 bg-purple-600 text-white rounded-full font-semibold hover:bg-purple-700 transition transform hover:scale-105">Get
                    Started <i class="fas fa-arrow-right ml-2"></i></a>
                <a href="#portfolio"
                    class="px-8 py-4 bg-slate-800 text-white rounded-full font-semibold hover:bg-slate-700 transition">View
                    Our Work</a>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-5xl mx-auto">
                <div class="flex flex-col items-center p-4 bg-slate-800/50 rounded-xl hover:bg-slate-800 transition"><i
                        class="fab fa-android text-4xl text-purple-500 mb-2"></i><span
                        class="text-sm text-slate-300">Android</span></div>
                <div class="flex flex-col items-center p-4 bg-slate-800/50 rounded-xl hover:bg-slate-800 transition"><i
                        class="fas fa-mobile-alt text-4xl text-blue-500 mb-2"></i><span
                        class="text-sm text-slate-300">Flutter</span></div>
                <div class="flex flex-col items-center p-4 bg-slate-800/50 rounded-xl hover:bg-slate-800 transition"><i
                        class="fas fa-code text-4xl text-green-500 mb-2"></i><span class="text-sm text-slate-300">Web
                        Apps</span></div>
                <div class="flex flex-col items-center p-4 bg-slate-800/50 rounded-xl hover:bg-slate-800 transition"><i
                        class="fas fa-globe text-4xl text-yellow-500 mb-2"></i><span
                        class="text-sm text-slate-300">Websites</span></div>
                <div class="flex flex-col items-center p-4 bg-slate-800/50 rounded-xl hover:bg-slate-800 transition"><i
                        class="fas fa-server text-4xl text-red-500 mb-2"></i><span
                        class="text-sm text-slate-300">DevOps</span></div>
                <div class="flex flex-col items-center p-4 bg-slate-800/50 rounded-xl hover:bg-slate-800 transition"><i
                        class="fas fa-pen-nib text-4xl text-cyan-500 mb-2"></i><span
                        class="text-sm text-slate-300">Design</span></div>
            </div>
        </div>
    </section>
    ...
    <section id="about" class="py-20 px-4 bg-slate-800/30">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-slate-300 max-w-3xl mx-auto">We are a dedicated cloud team committed to
                    delivering exceptional digital solutions that drive innovation and growth.</p>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
                <div class="text-center">
                    <div class="text-5xl font-bold text-purple-500 mb-2">{{ $stats['projects_completed'] }}+</div>
                    <div class="text-slate-400">Projects Completed</div>
                </div>
                <div class="text-center">
                    <div class="text-5xl font-bold text-purple-500 mb-2">{{ $stats['active_clients'] }}+</div>
                    <div class="text-slate-400">Active Clients</div>
                </div>
                <div class="text-center">
                    <div class="text-5xl font-bold text-purple-500 mb-2">{{ $stats['team_members'] }}+</div>
                    <div class="text-slate-400">Team Members</div>
                </div>
                <div class="text-center">
                    <div class="text-5xl font-bold text-purple-500 mb-2">{{ $stats['years_experience'] }}+</div>
                    <div class="text-slate-400">Years Experience</div>
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                <div class="bg-slate-800/50 p-8 rounded-xl border border-slate-700 text-center"><i
                        class="fas fa-lightbulb text-5xl text-purple-500 mb-4"></i>
                    <h3 class="text-2xl font-bold mb-3">Innovation</h3>
                    <p class="text-slate-400">We constantly explore new technologies to deliver cutting-edge solutions.
                    </p>
                </div>
                <div class="bg-slate-800/50 p-8 rounded-xl border border-slate-700 text-center"><i
                        class="fas fa-award text-5xl text-purple-500 mb-4"></i>
                    <h3 class="text-2xl font-bold mb-3">Excellence</h3>
                    <p class="text-slate-400">Quality is non-negotiable. We strive for excellence in every line of code.
                    </p>
                </div>
                <div class="bg-slate-800/50 p-8 rounded-xl border border-slate-700 text-center"><i
                        class="fas fa-handshake text-5xl text-purple-500 mb-4"></i>
                    <h3 class="text-2xl font-bold mb-3">Partnership</h3>
                    <p class="text-slate-400">Your success is our success. We work as an extension of your team.</p>
                </div>
            </div>
            @if($teamMembers->count() > 0)
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                    @foreach($teamMembers as $member)
                        <div
                            class="bg-slate-800/50 rounded-xl border border-slate-700 p-6 text-center hover:border-purple-500 transition">
                            <div
                                class="w-20 h-20 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center mx-auto mb-4 overflow-hidden">
                                @if($member->image_url)
    ...
    <section id="services" class="py-20 px-4">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-slate-300 max-w-3xl mx-auto">Comprehensive software development services tailored
                    to your business needs.</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse($services as $service)
                    <div
                        class="bg-slate-800/50 rounded-xl border border-slate-700 p-8 hover:border-purple-500 transition transform hover:scale-105">
                        @if($service->icon)
                        <div class="text-5xl mb-6 text-purple-500">{!! $service->icon !!}</div>@endif
                        ...
                        @if($service->features && count($service->features) > 0)
                            <ul class="space-y-2 mb-6">
                                @foreach(array_slice($service->features, 0, 4) as $feature)
                                    <li class="flex items-start text-slate-300 text-sm"><i
                                            class="fas fa-check-circle text-purple-500 mt-1 mr-2"></i><span>{{ $feature }}</span>
                                    </li>
                                @endforeach
                            </ul>
                        @endif
                ...
                @empty
                    <div class="col-span-full text-center py-12">
                        <p class="text-slate-400">No services available at the moment.</p>
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <section id="portfolio" class="py-20 px-4 bg-slate-800/30">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-slate-300 max-w-3xl mx-auto">Explore our completed projects and see how we've
                    helped businesses achieve their digital goals.</p>
            </div>

            @if(isset($portfolioItems) && $portfolioItems->count() > 0)
                <h3 class="text-2xl font-bold mb-8 text-center text-white"><span class="text-purple-500">Featured</span>
                    Work</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                    @foreach($portfolioItems as $item)
                        <div
                            class="bg-slate-800/80 backdrop-blur-lg rounded-xl border border-slate-700 overflow-hidden hover:border-purple-500 transition-all duration-300 flex flex-col transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-purple-500/20">
                            @if($item->image_url)
                                <div class="h-48 overflow-hidden bg-slate-900 border-b border-slate-700">
                                    <img src="{{ $item->image_url }}" alt="{{ $item->title }}"
                                        class="w-full h-full object-cover transition-transform duration-500 hover:scale-110">
                                </div>
                            @else
                                <div
                                    class="h-48 bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center border-b border-slate-700">
                            ...
                            <div class="p-6 flex-1 flex flex-col">
                                ...
                                @if($item->client_name)
                                    <div class="flex items-center mb-3 text-sm text-slate-400">
                                        <i class="fas fa-building mr-2 text-purple-500"></i>{{ $item->client_name }}
                                    </div>
                                @else
                                    <div class="mb-3"></div>
                                @endif
                                <p class="text-slate-300 text-sm mb-4 flex-1">
                                    {{ Str::limit($item->description, 100) ?: 'No description available for this project.' }}
                                </p>
                                @if($item->tech_tags)
                                    <div class="flex flex-wrap gap-2 mb-4">
                                        @foreach($item->tech_tags as $tech)
                                            <span
                                                class="px-2 py-1 bg-slate-900/50 border border-slate-700 text-slate-300 text-xs rounded">{{ $tech }}</span>
                                        @endforeach
                                    </div>
                                @endif
                                @if($item->project_url)
                                    <div class="mt-auto pt-3 border-t border-slate-700">
                                        <a href="{{ $item->project_url }}" target="_blank"
                                            class="text-purple-400 hover:text-purple-300 text-sm font-semibold inline-flex items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse($projects as $project)
                    <div
                        class="bg-slate-800/50 rounded-xl border border-slate-700 p-6 hover:border-purple-500 transition transform hover:scale-105">
                        <div class="flex items-start justify-between mb-4">
                            <h3 class="text-xl font-bold flex-1">{{ $project->name }}</h3>
                            <span
                                class="ml-2 px-3 py-1 text-xs rounded-full bg-green-600/20 text-green-400">{{ ucfirst($project->status) }}</span>
                        </div>
                        @if($project->client)
                ...
                @empty
                    <div class="col-span-full text-center py-12"><i
                            class="fas fa-folder-open text-6xl text-slate-700 mb-4"></i>
                        <p class="text-slate-400">Our portfolio projects will be displayed here soon.</p>
                    </div>
                @endforelse
            </div>
        </div>
    ...
    @if($featuredTestimonials->count() > 0)
        <section class="py-20 px-4">
            <div class="max-w-7xl mx-auto">
                <div class="text-center mb-16">
                    <h2 class="text-4xl md:text-5xl font-bold mb-6">What Our <span class="text-purple-500">Clients
                            Say</span></h2>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($featuredTestimonials as $testimonial)
                        <div class="bg-slate-800/50 p-6 rounded-xl border border-slate-700">
                            <div class="flex items-center mb-4">
                                <div class="w-12 h-12 rounded-full bg-purple-600 flex items-center justify-center mr-3"><span
                                        class="font-bold">{{ substr($testimonial->client_name, 0, 1) }}</span></div>
                                <div>
                                    <h4 class="font-semibold">{{ $testimonial->client_name }}</h4>
                                    @if($testimonial->client_company)
                                    <p class="text-sm text-slate-400">{{ $testimonial->client_company }}</p>@endif
                                </div>
                            </div>
                            <div class="flex mb-3">@for($i = 1; $i <= 5; $i++)<i
                            class="fas fa-star {{ $i <= $testimonial->rating ? 'text-yellow-400' : 'text-slate-600' }}"></i>@endfor
                            </div>
    ...
    <section id="contact" class="py-20 px-4 bg-slate-800/30">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-slate-300 max-w-3xl mx-auto">Have a project in mind? Let's discuss how we can
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="lg:col-span-2">
                    <div class="bg-slate-800/50 rounded-xl border border-slate-700 p-8">
                        @if(session('success'))
                            <div class="mb-6 p-4 bg-green-600/20 border border-green-600 rounded-lg text-green-400"><i
                        class="fas fa-check-circle mr-2"></i>{{ session('success') }}</div>@endif
                        @if(session('error'))
                            <div class="mb-6 p-4 bg-red-600/20 border border-red-600 rounded-lg text-red-400"><i
                        class="fas fa-exclamation-circle mr-2"></i>{{ session('error') }}</div>@endif
                        <form action="{{ route('contact.store') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div><label class="block text-sm font-medium text-slate-300 mb-2">Company</label><input
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div><label class="block text-sm font-medium text-slate-300 mb-2">Service
                                        ...
                                        class="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-purple-500">
                                        <option value="">Select a service...</option>@foreach($services as $service)
                                        <option value="{{ $service->title }}">{{ $service->title }}</option>@endforeach
                                    </select></div>
                                <div><label class="block text-sm font-medium text-slate-300 mb-2">Budget
                                        Range</label><select name="budget_range"
                                        class="w-full bg-slate-900 border border-slate-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-purple-500">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-slate-800/50 rounded-xl border border-slate-700 p-6">
                        ...
                        <div class="flex space-x-4">
                            <a href="#"
                                class="w-12 h-12 bg-slate-700 rounded-lg flex items-center justify-center hover:bg-purple-600 transition"><i
        ...
        <div class="max-w-7xl mx-auto px-4 py-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                <div class="col-span-1 md:col-span-2">
                    <div class="mb-3"><x-logo /></div>
                    <p class="text-slate-400 mb-4">A dedicated cloud team specializing in modern software development.
                    </p>
                </div>
                <div>
                    <h4 class="font-semibold mb-3">Quick Links</h4>
                    <ul class="space-y-2">
                        <li><a href="#home" class="text-slate-400 hover:text-purple-500">Home</a></li>
                        <li><a href="#about" class="text-slate-400 hover:text-purple-500">About</a></li>
                        <li><a href="#services" class="text-slate-400 hover:text-purple-500">Services</a></li>
                        <li><a href="#portfolio" class="text-slate-400 hover:text-purple-500">Portfolio</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="font-semibold mb-3">Contact</h4>
                    <ul class="space-y-2 text-slate-400">
                        <li><a href="#contact" class="hover:text-purple-500">Get In Touch</a></li>
                        <li><a href="mailto:asynchronousd@gmail.com"
                                class="hover:text-purple-500">asynchronousd@gmail.com</a></li>@auth<li><a
                                href="{{ route('dashboard') }}" class="hover:text-purple-500">Dashboard</a></li>@endauth
                    </ul>
                </div>
            </div>
